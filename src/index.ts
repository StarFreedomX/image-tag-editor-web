...
const app = express()
const port = 3567 // 可以按需修改

const config: Config = JSON.parse(fs.existsSync('./src/config.json') ? fs.readFileSync('./src/config.json', 'utf-8') : '{}');
...
function tokenAuthorized(folder: string, token: any){
